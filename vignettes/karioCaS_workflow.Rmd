...
By setting the arguments to `"auto"`, the package natively reads the SI audit written by `taxa_retention()` and applies the mathematically optimal *Primary SI* for each domain.
