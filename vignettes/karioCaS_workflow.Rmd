...
Finally, `taxa_resolution(project_dir = proj_dir)` (with no `CS`) inspects the Parent-to-Child resolution of this final mosaic. To make that view meaningful, build the mosaic with `tax_level = NULL` so the parent ranks are retained alongside the species.
